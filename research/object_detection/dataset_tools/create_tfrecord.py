...
class FLAGS:
    csv_input = Path('../data/val_labels.csv').resolve().as_posix()
    output_path = Path('../data/val.record').resolve().as_posix()
    image_dir = Path('../images/').resolve().as_posix()
